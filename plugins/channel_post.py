...
async def channel_post(client: Client, message: Message):
    reply_text = await message.reply_text("<code>Tunggu Sebentar sall...</code>", quote=True)
    try:
        ...
        await reply_text.edit_text("<b>Telah Terjadi Error isall...</b>")
        return
    ...
    await reply_text.edit(
        f"<b>Link Sharing File Berhasil Di Buat tuh sall :</b>\n\n{link}",
